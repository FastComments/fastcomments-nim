...
type DeleteSSOUserAPIResponse* = object
  ## 
...
# Custom JSON deserialization for DeleteSSOUserAPIResponse with custom field names
proc to*(node: JsonNode, T: typedesc[DeleteSSOUserAPIResponse]): DeleteSSOUserAPIResponse =
  result = DeleteSSOUserAPIResponse()
...
# Custom JSON serialization for DeleteSSOUserAPIResponse with custom field names
proc `%`*(obj: DeleteSSOUserAPIResponse): JsonNode =
  result = newJObject()
