...
type GetSSOUserByEmailAPIResponse* = object
  ## 
...
# Custom JSON deserialization for GetSSOUserByEmailAPIResponse with custom field names
proc to*(node: JsonNode, T: typedesc[GetSSOUserByEmailAPIResponse]): GetSSOUserByEmailAPIResponse =
  result = GetSSOUserByEmailAPIResponse()
...
# Custom JSON serialization for GetSSOUserByEmailAPIResponse with custom field names
proc `%`*(obj: GetSSOUserByEmailAPIResponse): JsonNode =
  result = newJObject()
