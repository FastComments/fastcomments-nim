...
type UpdateSubscriptionAPIResponse* = object
  ## 
...
# Custom JSON deserialization for UpdateSubscriptionAPIResponse with custom field names
proc to*(node: JsonNode, T: typedesc[UpdateSubscriptionAPIResponse]): UpdateSubscriptionAPIResponse =
  result = UpdateSubscriptionAPIResponse()
...
# Custom JSON serialization for UpdateSubscriptionAPIResponse with custom field names
proc `%`*(obj: UpdateSubscriptionAPIResponse): JsonNode =
  result = newJObject()
