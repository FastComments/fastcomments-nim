...
type GetSSOUserByIdAPIResponse* = object
  ## 
...
# Custom JSON deserialization for GetSSOUserByIdAPIResponse with custom field names
proc to*(node: JsonNode, T: typedesc[GetSSOUserByIdAPIResponse]): GetSSOUserByIdAPIResponse =
  result = GetSSOUserByIdAPIResponse()
...
# Custom JSON serialization for GetSSOUserByIdAPIResponse with custom field names
proc `%`*(obj: GetSSOUserByIdAPIResponse): JsonNode =
  result = newJObject()
